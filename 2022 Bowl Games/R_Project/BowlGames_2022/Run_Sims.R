...
og_2022 <- run_simulations_function(picks_dataset = BowlGames_2022, numberofsimulations = 10000)
og_2022$time_to_run
og_2022$Probability_Of_Winning %>% arrange(-Percent_Won)
og_2022$Probability_Of_Winning

cat_2022 <- run_simulations_function(picks_dataset = BowlGames_2022_pluscat, numberofsimulations = 10000)
cat_2022$time_to_run
cat_2022$Probability_Of_Winning %>% arrange(-Percent_Won)
cat_2022$Probability_Of_Winning
