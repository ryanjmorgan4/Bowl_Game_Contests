...
BowlGames_2022_pluscat <- as.data.frame(read.csv("C:\\Users\\Ryan\\Desktop\\Home\\2022 Bowl Games\\bowlgames_2022.csv", stringsAsFactors = FALSE), stringsAsFactors = FALSE)
...
Unique_Games(BowlGames_2022)
Unique_Games(BowlGames_2022_pluscat)
...
pick_comparisons(BowlGames_2022)
pick_comparisons(BowlGames_2022_pluscat)
