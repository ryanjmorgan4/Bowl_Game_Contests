...
probabilities <- (as.data.frame(read.csv("C:\\Users\\Ryan\\Desktop\\Home\\2020 Bowl Games\\Prob_Tracker.csv", stringsAsFactors = FALSE), stringsAsFactors = FALSE))
...
Scores <- (as.data.frame(read.csv("C:\\Users\\Ryan\\Desktop\\Home\\2020 Bowl Games\\Score_Tracker.csv", stringsAsFactors = FALSE), stringsAsFactors = FALSE))
