...
calculate_score <- function(key_vector, picks_vector, 
                            index_ny6_games = c(15, 20, 22, 23, 26, 27, 28), 
                            index_semis = c(22, 23, 28),
                            index_champ = c(28)){
  return(
    sum(
...
og_2020 <- run_simulations_function(picks_dataset = BowlGames_2020, numberofsimulations = 100000)
og_2020$time_to_run
og_2020$Probability_Of_Winning %>% arrange(-Percent_Won)

cat_2020 <- run_simulations_function(picks_dataset = BowlGames_2020_pluscat, numberofsimulations = 100000)
