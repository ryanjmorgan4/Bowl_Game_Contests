...
#New Years Six Games:
#   Peach Bowl (row 30)
#   Cotton Bowl (semi final)(row 35)
#   Orange Bowl (semi final) (row 36)
#   Fiesta Bowl (row 39)
#   Rose Bowl (row 40)
#   Sugar Bowl (row 41)
...
calculate_score_comparison(BowlGames_2021)
check_if_still_in_contention(BowlGames_2021)
different_picks_remaining(BowlGames_2021)



calculate_score_comparison(BowlGames_2021_pluscat)
check_if_still_in_contention(BowlGames_2021_pluscat)
different_picks_remaining(BowlGames_2021_pluscat)
