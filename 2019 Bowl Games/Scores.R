...
#   Cotton Bowl (row 16)
#   Peach Bowl (row 21)
#   Rose Bowl (semi final) (row 23)
#   Sugar Bowl (semi final) (row 24)
#   Fiesta Bowl (row 27)
#   Orange Bowl (row 28)
#   National Championship (row 29)
...
calculate_score <- function(key_vector, picks_vector, 
                            index_ny6_games = c(16, 21, 23, 24, 27, 28, 29), 
                            index_semis = c(23, 24, 29),
                            index_champ = c(29)){
  return(
    sum(
...
calculate_score_comparison(BowlGames_2020)
check_if_still_in_contention(BowlGames_2020)
different_picks_remaining(BowlGames_2020)



calculate_score_comparison(BowlGames_2020_pluscat)
check_if_still_in_contention(BowlGames_2020_pluscat)
different_picks_remaining(BowlGames_2020_pluscat)
