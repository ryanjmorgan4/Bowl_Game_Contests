...
#Semi-Final Games:
#   Rose Bowl (semi final) (row 41)
#   Sugar Bowl (semi final) (row 42)
#   National Championship (row 43)
...
calculate_score_comparison(BowlGames_2023)
check_if_still_in_contention(BowlGames_2023)
different_picks_remaining(BowlGames_2023)



calculate_score_comparison(BowlGames_2023_pluscat)
check_if_still_in_contention(BowlGames_2023_pluscat)
different_picks_remaining(BowlGames_2023_pluscat)
